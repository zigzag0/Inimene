		...
		<table>
			...
			<tr>
				...
				<td><input type="text" name="inimene_number"
					...
					<% if(errors.containsKey("inimene_number")){%><font color="red"><%= errors.get("inimene_number") %></font>
					<%}%></td>
			</tr>
			<tr>
				...
				<td><input type="text" name="inimene_name1"
					value="<%= inimene.getName1() == null ? "" : inimene.getName1() %>" />
					<% if(errors.containsKey("inimene_name1")){%><font color="red"><%= errors.get("inimene_name1") %></font>
					<%}%></td>
			</tr>
			<tr>
				<td>Name2:</td>
				<td><input type="text" name="inimene_name2"
					value="<%= inimene.getName2() == null ? "" : inimene.getName2() %>" />
					<% if(errors.containsKey("inimene_name2")){%><font color="red"><%= errors.get("inimene_name2") %></font>
					<%}%></td>
			</tr>
			...
			<tr>
				...
				<td><input type="text" name="inimene_bday"
					value="<%= inimene.getBday() == null ? "" : new SimpleDateFormat("yyyy-MM-dd").format(inimene.getBday()) %>" />
